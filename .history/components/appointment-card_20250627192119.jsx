...
const AppointmentCard = ({ appointment, userRole }) => {
    ...
    const handleSaveNotes = async () => {
        ...
        const formData = new FormData();
        formData.append("appointmentId",appoint)
    }
                    ...
                    <div className="space-y-2">
                        ...
                        <div className='space-y-2'>
                            ...
                            {userRole === "DOCTOR" && action === "notes" ? (
                                <div className='space-y-3'>
                                    ...
                                    <div className='flex justify-end space-x-2'>
                                        ...
                                        <Button                                            
                                            ...
                                            className="bg-emerald-600/30 text-white  hover:bg-emerald-700"
                                ...
                                <div className="p-3 rounded-md bg-muted/20 border text-white border-emerald-900/20 min-h-[80px]">
                                        {appointment.notes ? (
                                            <p className='text-white whitespace-pre-line'>
                                                {appointment.notes}
                                            </p>
