    ...
    try {
      // Initialize the session
        ...
        sessionRef.current.on("streamCreated", (event) => {
            ...
            // Prevent subscribing to your own stream
            if (event.stream.connection.connectionId === sessionRef.current.connection.connectionId) {
                console.log("Skipping self-subscription");
                return;
            }
