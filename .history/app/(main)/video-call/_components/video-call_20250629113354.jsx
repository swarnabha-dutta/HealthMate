...
const VideoCall = ({ sessionId, token }) => {
    ...
    const initializeSession = () => {
        ...
        try {
            ...
            // Create publisher after session is initialized
    ...
    // Cleanup when component unmount like user click the back button or close the window
    useEffect(() => {
        return () => {
            if (publisherRef.current) {
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
                    ...
                    <div className="relative bg-gray-900 rounded-lg overflow-hidden">
                        <div id="publish" className="w-full h-64 lg:h-80"></div>
                    ...
                    <div className="relative bg-gray-900 rounded-lg overflow-hidden">
                        <div id="subscriber" className="w-full h-64 lg:h-80"></div>
                        <div className="absolute bottom-2 left-2 bg-black bg-opacity-50 text-white px-2 py-1 rounded text-sm">
                            Doctor
                        </div>
                    </div>
