                ...
                <Card className="border-emerald-900/20"> 
                    ...
                    <CardContent>
                        ...
                        <p className="text-muted-foreground mb-6">
                            {isRejected ? (
                                <>
                                <span style={{ backgroundColor: '#60a5fa', color: '#fff', padding: '2px 4px', borderRadius: '4px' }}>
                                    You can update your doctor profile and resubmit for verification.
                                </span>
                                </>
                            ) : (
                                <>
                                <span style={{ backgroundColor: '#3b82f6', color: '#fff', padding: '2px 4px', borderRadius: '4px' }}>
