            ...
            <div className='max-w-2xl mx-auto'>
                <Card className="border-emerald-900/20"> 
                    <CardHeader className="text-center">
                        ...
                        <CardDescription>
                            {isRejected ? (
                                "Your verification request has been rejected. Please try again or contact our support team for further assistance."
                            ) : (
                                "Your verification is in progress. We will get back to you soon to verify your account."
                      </CardDescription>
