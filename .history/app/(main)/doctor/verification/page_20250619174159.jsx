...
import { AlertCircle, ClipboardCheck, Link, XCircle } from 'lucide-react';
            ...
            <div className='max-w-2xl mx-auto'>
                <Card className="border-emerald-900/20"> 
                    ...
                    <CardContent>
                        {isRejected ?( <div className='bg-red-900/10 border border-red-900/20 rounded-lg p-4 mb-6 flex items-start'>
                            ...
                            <div className='bg-red-900/10 border border-red-900/20 rounded-lg p-4 mb-6 flex items-start'>
                                ...
                                <p className="text-muted-foreground text-left">
                                    Your profile is currently under review by our administrative team. This process
                                    typically takes 1-2 business days. You'll receive an email notification once your
                                    account is verified.
                                </p>
                            </div>
                        )}
                        <p>
                            {isRejected
                                ? "You can update your doctor profile adn resubmit for verification."
                                :"While You wait ,you can familiarize yourself with our platform. or contact us if you have any questions."
                            }
                        </p>
