 ...
 * @returns {object|null} Updated user object with allocated credits or null if there was an error
 */
export async function checkAndAllocateCredits(user) {
    try {
        ...
        // We use the month and year as the identifier for the current month
        ...
        // We use a transaction to ensure that the credits are allocated and the transaction record is created in one go
...
/*******  59242bdb-1e93-440c-9abc-3d623602d000  *******/
